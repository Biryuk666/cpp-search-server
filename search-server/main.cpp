...
public:
    ...
    vector<Document> FindTopDocuments(const string& raw_query) const {
        ...
        return FindTopDocuments(raw_query, doc_status);
    }
    ...
    vector<Document> FindTopDocuments(const string& raw_query, /*bool(*)(int, DocumentStatus, int)*/ Predicate predicate) const {
